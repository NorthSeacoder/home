    ...
    <main id="contact-me" class="page">
        ...
        <div id="page-menu" class="w-full h-full flex flex-col border-right">
            ...
            <div id="find-me-in" class="submenu border-top">
                ...
                <div id="links">
                    <div v-for="{url, icon, key, title} in contact.find_me_also_in.sources" :key="key" class="link">
                        <!-- <img :src="icon" /> -->
                        <a :href="url" class="font-fira_retina text-menu-text hover:text-white" target="_blank">{{
                            title
                        }}</a>
                    </div>
                </div>

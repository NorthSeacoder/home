...
export default {
  ...
  methods: {
    filterProjects(tech) {
      ...
      this.filters[0] == 'all' ? this.projects = this.config.projects : this.projects = this.filterProjectsBy(this.filters);
    ...
    filterProjectsBy(filters) {
      const projectArray = Object.values(this.config.projects);
